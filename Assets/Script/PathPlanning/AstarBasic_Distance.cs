...
{
    public class Astar_Basic_Distance
    {
        ...
        public static List<Tuple<ConnectionPoint, float>> AstarAlgorithm_Basic_Distance(Graph graph, RoutePoint startPosition, RoutePoint endPosition, float speed)
        {
            ...
            while (openSet.Count != 0)
            {
                ...
                foreach (ConnectionPoint neighbor in current.Children)
                {
                    ...
                    float tentative_gscore = g_score[current] + distance;
